...
$all_items = load_data('certificates.json');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Professional Certificates - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title>Professional Certificates | Prof. Festus Uwakhemen Asikhia</title>
...
<body>
    ...
    <main>
        <section class="certificates section-padding" id="certificates" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal">
                    ...
                    <p class="section-subtitle">Globally recognized certifications from leading institutions across leadership, policy, finance, and technology.</p>
                </div>
                <div class="certificates-grid stagger-children">
                    <?php foreach ($all_items as $cert): ?>
                    <div class="certificate-card">
                        <div class="cert-icon"><i class="fas fa-certificate"></i></div>
                        <h5><?= htmlspecialchars($cert['title']) ?></h5>
                        <span><?= htmlspecialchars($cert['institution']) ?></span>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
