...
$all_items = load_data('politics.json');
$page_title = 'Political Career';
$page_subtitle = 'Political involvement and public service contributions.';
ksort($all_items);
?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Political Career - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title>Political Career | Prof. Festus Uwakhemen Asikhia</title>
...
<body>
    ...
    <main>
        <section class="politics section-padding" id="politics" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal">
                    ...
                    <p class="section-subtitle">A dedicated public servant committed to good governance, policy reform, and community development through strategic political leadership.</p>
                </div>
                <div class="politics-grid stagger-children">
                    <?php foreach ($all_items as $key => $item): ?>
                    <a href="single-politics.php?id=<?= $key ?>" class="politics-card">
                        <div class="pol-icon"><i class="fas <?= $item['icon'] ?>"></i></div>
                        <h3><?= $item['title'] ?></h3>
                        <div class="pol-position"><?= $item['position'] ?></div>
                        <div class="pol-period"><i class="fas fa-calendar-alt"></i> <?= $item['period'] ?></div>
