...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars($journal['title']) ?> - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title><?= htmlspecialchars($journal['title']) ?> | Prof. Festus Uwakhemen Asikhia</title>
        ...
        <section class="awards section-padding" id="journal" style="padding-top: 140px;">
            <div class="container">
                <div class="single-blog-header reveal">
                    <a href="journal.php" class="btn btn-outline" style="margin-bottom: 24px; display: inline-block;">
                        <i class="fas fa-arrow-left"></i> Back to Journal
                    </a>
                    <div class="blog-meta" style="justify-content: center;">
                        <span><i class="fas fa-book"></i> <?= $journal['journal'] ?></span>
                        <span><i class="fas fa-bookmark"></i> <?= $journal['volume'] ?></span>
                    </div>
                    <h1><?= $journal['title'] ?></h1>
                </div>
                <div class="single-blog-content reveal">
                    <?php foreach ($journal['content'] as $paragraph): ?>
                        <p><?= $paragraph ?></p>
                    <?php endforeach; ?>
                </div>
            </div>
