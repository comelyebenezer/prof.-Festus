...
<head>
    ...
    <meta name="description" content="Property Development Detail - Prof. Festus Uwakhemen Asikhia">
        ...
        <section class="section-padding" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal" style="text-align: left; max-width: 100%;">
                    <a href="real-estate.php" class="btn btn-outline" style="display: inline-block; margin-bottom: 16px;">
                        <i class="fas fa-arrow-left"></i> Back to Real Estate
                    </a>
                    <span class="section-label" style="text-align: left;"><?= htmlspecialchars($item['company']) ?></span>
                    <h2 class="section-title" style="font-size: 2rem; text-align: left;"><?= htmlspecialchars($item['title']) ?></h2>
                </div>
                <div class="single-content stagger-children" style="max-width: 800px; margin: 0 auto;">
                    <div class="single-meta" style="display: flex; gap: 16px; flex-wrap: wrap; margin-bottom: 32px;">
                        ...
                        <span style="background: rgba(212,168,67,0.1); color: var(--gold); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem;">
                            <i class="fas fa-calendar-alt"></i> <?= htmlspecialchars($item['year']) ?>
                        </span>
                        <span style="background: rgba(212,168,67,0.1); color: var(--gold); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem;">
                            <i class="fas fa-tag"></i> <?= htmlspecialchars($item['status']) ?>
                        </span>
                    </div>
