...
$page_subtitle = 'Honours and recognitions received for contributions to academia and research.';
ksort($all_items);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Honors & Awards - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title>Honors & Awards | Prof. Festus Uwakhemen Asikhia</title>
    ...
    <nav class="navbar" id="navbar">
        <div class="container">
            ...
            <div class="nav-links">
                ...
                <a href="awards.php" class="active">Awards</a>
        ...
        <section class="awards section-padding" id="awards" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal">
                    ...
                    <h2 class="section-title">All Honors & Awards</h2>
                    <p class="section-subtitle">Over 25 prestigious awards recognizing excellence in academia, real estate, politics, and community service.</p>
                </div>
                <div class="awards-grid stagger-children">
                    <?php foreach ($all_items as $key => $award): ?>
                    <a href="single-award.php?id=<?= $key ?>" class="award-card">
                        <div class="award-icon"><i class="fas <?= $award['icon'] ?>"></i></div>
                        <div class="award-info">
                            <h4><?= htmlspecialchars($award['title']) ?></h4>
                            <div class="award-org"><?= htmlspecialchars($award['org']) ?></div>
                            <div class="award-year"><?= htmlspecialchars($award['year']) ?></div>
