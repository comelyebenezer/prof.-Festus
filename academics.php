...
$all_items = load_data('academics.json');
$page_title = 'Academic Career';
$page_subtitle = 'My educational journey and academic appointments.';
ksort($all_items);
?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Educational Background - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title>Educational Background | Prof. Festus Uwakhemen Asikhia</title>
...
<body>
    ...
    <main>
        <section class="academics section-padding" id="academics" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal">
                    ...
                    <p class="section-subtitle">A distinguished academic career built on a foundation of rigorous scholarship, research excellence, and commitment to knowledge dissemination.</p>
                </div>
                <div class="academics-grid stagger-children">
                    <?php foreach ($all_items as $key => $item): ?>
                    <a href="single-academic.php?id=<?= $key ?>" class="academic-card">
                        <div class="academic-icon"><i class="fas <?= $item['icon'] ?>"></i></div>
                        <div class="academic-info">
                            <h4><?= $item['institution'] ?></h4>
                            <div class="academic-degree"><?= $item['degree'] ?></div>
                            <div class="academic-year"><?= $item['year'] ?></div>
