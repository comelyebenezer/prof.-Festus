...
$all_items = load_data('journal.json');
$page_title = 'Journal Publications';
$page_subtitle = 'Peer-reviewed research and academic publications in accounting and business.';
ksort($all_items);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Academic Journal - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title>Journal | Prof. Festus Uwakhemen Asikhia</title>
...
<body>
    ...
    <main>
        <section class="awards section-padding" id="journal" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal">
                    ...
                    <p class="section-subtitle">Peer-reviewed research publications and scholarly articles contributing to knowledge in organizational leadership, educational management, and policy development.</p>
                </div>
                <div class="awards-grid stagger-children">
                    <?php foreach ($all_items as $key => $journal): ?>
                    <a href="single-journal.php?id=<?= $key ?>" class="award-card">
                        <div class="award-icon"><i class="fas <?= $journal['icon'] ?>"></i></div>
                        <div class="award-info">
                            <h4><?= htmlspecialchars($journal['title']) ?></h4>
                            <div class="award-org"><?= htmlspecialchars($journal['journal']) ?></div>
                            <div class="award-year"><?= htmlspecialchars($journal['volume']) ?></div>
