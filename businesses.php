...
$page_title = 'Business Enterprises';
$page_subtitle = 'Entrepreneurial ventures and corporate leadership.';
ksort($all_items);
?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Business Enterprises - Prof. Festus Uwakhemen Asikhia">
    <meta name="author" content="Prof. Festus Uwakhemen Asikhia">
    <title>Business Enterprises | Prof. Festus Uwakhemen Asikhia</title>
...
<body>
    ...
    <main>
        <section class="businesses section-padding" id="businesses" style="padding-top: 140px;">
            <div class="container">
                <div class="section-header reveal">
                    ...
                    <p class="section-subtitle">A diversified portfolio of successful business ventures spanning real estate, education, agriculture, consulting, and hospitality.</p>
                </div>
                <div class="businesses-grid stagger-children">
                    <?php foreach ($all_items as $key => $item): ?>
                    <a href="single-business.php?id=<?= $key ?>" class="business-card">
                        <div class="biz-icon"><i class="fas <?= $item['icon'] ?>"></i></div>
                        <h3><?= $item['title'] ?></h3>
                        <div class="biz-role"><?= $item['role'] ?></div>
                        <p><?= $item['description'] ?></p>
                        <span class="biz-industry"><?= $item['industry'] ?></span>
                    </a>
                    <?php endforeach; ?>
                </div>
            </div>
